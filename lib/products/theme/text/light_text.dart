...
class TextThemeLight implements ITextTheme {
  ...
  TextThemeLight(this.primaryColor, this.fontFamily, {IColors? colorTheme}) {
    subtitle1 = subtitle1?.apply(color: colorTheme?.colors.text);
    subtitle2 = subtitle2?.apply(color: colorTheme?.colors.text);
    headline5 = headline5?.apply(color: colorTheme?.colors.text);
    headline3 = headline3?.apply(color: colorTheme?.colors.text);
    data = TextTheme(
